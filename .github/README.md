...
[`@aws-sdk/client-shield`](https://www.npmjs.com/package/@aws-sdk/client-shield/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-shield@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BQ6S5y9HA+bVjTo9yDreoCkXXshQqJll/UIQpXOUslt59s6CtpUCgMSMcvt4RNdW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-shield": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-shield@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-shield@3.408.0/index.min.mjs": "sha384-BQ6S5y9HA+bVjTo9yDreoCkXXshQqJll/UIQpXOUslt59s6CtpUCgMSMcvt4RNdW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-shield/blob/refs/tags/3.408.0/LICENSE
```
